...
func GetListener(chain uint64) (listener IChainListener) {
	switch chain {
	case base.ETH, base.BSC, base.HECO, base.O3, base.PIXIE, base.HSC, base.BYTOM:
...
func GetSubmitter(chain uint64) (submitter IChainSubmitter) {
	switch chain {
	case base.ETH, base.BSC, base.HECO, base.O3, base.ARBITRUM, base.XDAI, base.OPTIMISM, base.FANTOM, base.AVA, base.METIS, base.RINKEBY, base.BOBA, base.PIXIE, base.OASIS, base.HSC, base.BYTOM, base.HARMONY, base.ONTEVM:
