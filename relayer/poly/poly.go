	...
	if len(headers) > 0 {
		...
		if err == nil && header != nil {
			...
			if s.lastCommit > 0 && s.lastCheck > 3 {
				s.lastCheck = 0
				switch chainId {
				case base.ETH, base.HECO, base.BSC, base.MATIC, base.O3, base.STARCOIN, base.BYTOM:
...
func (s *Submitter) ReadyBlock() (height uint64) {
	...
	case base.ETH, base.BSC, base.HECO, base.O3, base.MATIC, base.STARCOIN, base.BYTOM:
